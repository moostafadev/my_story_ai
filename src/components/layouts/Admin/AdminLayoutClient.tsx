...
const AdminLayoutClient = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <>
      ...
      <main
        className={cn(
          "overflow-hidden !mr-16 m-2 mt-[72px] p-3 md:p-4 space-y-4 md:space-y-8 rounded-md shadow-sm hover:shadow-md bg-white min-h-[calc(100vh-72px-8px)] duration-300",
